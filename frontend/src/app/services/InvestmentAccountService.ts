...
export class InvestmentAccountService {
  ...
  getAllInvestmentAccounts(userId?: number): Observable<InvestmentAccount[]> {
    ...
    return this.http
      ...
      .pipe(catchError(() => throwError(() => new Error('Failed to load InvestmentAccounts.'))));
  }
  ...
  createInvestmentAccount(investmentAccount: InvestmentAccount): Observable<InvestmentAccount> {
    return this.http
      ...
      .pipe(catchError(() => throwError(() => new Error('Failed to create InvestmentAccount.'))));
  }
  ...
  updateInvestmentAccount(
    ...
    return this.http
      ...
      .pipe(catchError(() => throwError(() => new Error('Failed to update InvestmentAccount.'))));
  }

  deleteInvestmentAccount(id: number): Observable<void> {
    return this.http
      .delete<void>(this.URL + `/${id}`)
      .pipe(catchError(() => throwError(() => new Error('Failed to delete InvestmentAccount.'))));
  }
  ...
  getRecentAccounts(userId: number): Observable<InvestmentAccount[]> {
    ...
    params = params.set('userId', userId);
    return this.http
      .get<InvestmentAccount[]>(this.URL + `/recent`, { params })

      .pipe(
        catchError(() =>
          throwError(() => new Error("Failed to load user's recent investment accounts.")),
        ),
      );
  }
}
